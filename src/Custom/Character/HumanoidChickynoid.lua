...
function ChickynoidStyle:ServerSetup(simulation)

    --Automatically replicated down to client
    ...
    simulation.constants.pushSpeed = 16 --set this lower than maxspeed if you want stuff to feel heavy
    simulation.constants.stepSize = 2.2    
end

function ChickynoidStyle:DefineAnimations()
